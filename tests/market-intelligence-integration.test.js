...
describe("Market intelligence integration contract", () => {
  it("runs market intelligence before the final market R&D policy layer", function() {
    ...
    assert.match(pkg.scripts["apply:runtime"], /apply:product-lifecycle && pnpm run apply:market-intelligence && pnpm run apply:market-rd$/);
  });
