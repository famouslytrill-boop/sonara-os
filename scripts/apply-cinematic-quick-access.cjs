...
const marker = '<section class=\\"sonara-section sonara-status-panel\\" aria-label=\\"Truthful readiness\\">';
const quickAccess = `<section class="sonara-section sonara-status-panel" aria-label="Company quick access">
