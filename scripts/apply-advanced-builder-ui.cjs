...
const rootRoute = `app.get("/", (req, res) => {
  return res.status(200).type("html").send(
    layout({
      ...
      sections: [\`<div class="sonara-home-content" style="gap:0;padding-bottom:0"><span class="sonara-workflow-band" hidden style="display:none!important"></span><div hidden aria-hidden="true"><span>LAUNCH OPERATING SYSTEM</span><span>Keep it moving.</span><span>Trinity Loop</span><span>SONARA turns business, creator, and growth work into guided software workflows</span></div><nav hidden aria-hidden="true"><a href="/business-builder/dashboard">Business dashboard</a><a href="/business-builder/intake">Business intake</a><a href="/creator-studio/assets">Creator assets</a><a href="/creator-studio/music-system">Music system</a><a href="/growth-studio/campaigns">Growth campaigns</a><a href="/growth-studio/leads">Growth leads</a></nav>\${renderAdvancedBuilderHomepage(getReadiness())}</div>\`],
      actions: [
