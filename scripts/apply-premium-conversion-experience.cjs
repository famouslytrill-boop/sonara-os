...
const translations = [
  ...
  ["Each company keeps its own workflows and records while identity, access, billing, support, and delivery remain connected through SONARA One.", "Each company has a clear job, its own workflow, and honest availability while identity, billing, evidence, and support stay connected.", "English company body"],
  ...
  ["Begin free. Add depth when the work demands it.", "Create a free account. Add paid systems only when they are verified.", "English CTA heading"],
