...
const continuityCopy = String.raw`${continuityAnchor}<p class=\"sonara-continuity-note\"><strong>Build, create, and grow—without losing control.</strong> One system. Three focused ways to move.</p>`;
