...
// The proprietary notice is emitted here, not added to the output by hand.
// scripts/verify-proprietary-notice.mjs requires every shipped source file to
// carry it, and this file is generated -- so a notice added to the output would
// make `--check` report the file stale on the next run. It belongs in the
// template.
const contents = `// Copyright (c) 2026 SONARA Industries. All rights reserved.
