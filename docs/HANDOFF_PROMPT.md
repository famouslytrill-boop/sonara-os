...
- One Express 4 CommonJS server (`server.js`, currently 4043 lines) served on Vercel through `api/index.js`.
...
- 111 test files run under mocha. `pnpm test` is the whole suite and takes about ten seconds.
