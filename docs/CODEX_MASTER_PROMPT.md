...
- Monthly subscriptions: `STRIPE_PRICE_STARTER_MONTHLY`, `STRIPE_PRICE_PRO_ARTIST_MONTHLY`, `STRIPE_PRICE_STUDIO_MONTHLY`
- One-time kits: `STRIPE_PRICE_STARTER_PROMPT_PACK`, `STRIPE_PRICE_VISUAL_IDENTITY_PROMPT_PACK`, `STRIPE_PRICE_AR_MARKET_AUDIT_KIT`, `STRIPE_PRICE_RELEASE_PLANNER_KIT`, `STRIPE_PRICE_ARTIST_OS_PRO_KIT`, `STRIPE_PRICE_ALBUM_BUILDER_SYSTEM`, `STRIPE_PRICE_LOCAL_BUSINESS_MARKETING_KIT`, `STRIPE_PRICE_REVENUE_PATHWAY_BLUEPRINT`
