...
across all 38 commands. The test count is deliberately not written here
...
**Some of it cannot be built as stated.** Of 183 reviewed repositories, 23 carry a
...
- **38** verification commands in the release chain
