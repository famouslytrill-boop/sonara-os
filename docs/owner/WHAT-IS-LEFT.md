...
across all 24 commands. The test count is deliberately not written here
...
**Some of it cannot be built as stated.** Of 111 reviewed repositories, 11 carry a
reciprocal licence (AGPL/GPL/OSL/SSPL), which triggers on network use and so
reaches a hosted product; 6 declare no licence at all — which is not a review
...
- **306** tables created by the migrations, **213** of them organization-scoped
- **23** owner record pages, **22** record checks
- **24** verification commands in the release chain
