...
**Some of it cannot be built as stated.** Of 217 reviewed repositories, 30 carry a
reciprocal licence (AGPL/GPL/OSL/SSPL), which triggers on network use and so
reaches a hosted product; 12 declare no licence at all — which is not a review
