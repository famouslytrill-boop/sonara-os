...
SONARA Exchange™ marketplace features are delayed until seller onboarding, rights verification, payout compliance, moderation, refund/support policy, marketplace terms, and storage cost modeling are ready.

SONARA does not sell third-party sample packs at launch.
