export type AppCode = "parent_admin" | "trackfoundry" | "lineready" | "noticegrid";
...
export const appSessionCookies: Record<AppCode, string> = {
  ...
  trackfoundry: "trackfoundry_session",
  lineready: "lineready_session",
  noticegrid: "noticegrid_session",
};
