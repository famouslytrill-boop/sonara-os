...
export const openSourceTools: OpenSourceToolRecord[] = [
  ...
  },
  {
    ...
    category: ["2026 repository sweep research-only", "headless CMS", "data platform", "source-available licence"],
  ...
  },
  {
    ...
    category: ["2026 repository sweep research-only", "customer support", "support inbox", "self-hosted service research"],
    ...
    license: "MIT; content outside enterprise/ is MIT Expat, while enterprise/ is separately licensed",
    licenseRisk: "medium",
    reciprocalLicense: false,
    commercialUseStatus: "needs_review",
    integrationStatus: "reference_only",
  ...
  },
  {
    ...
    category: ["2026 repository sweep research-only", "workflow automation", "integration service"],
  ...
  },
  {
    ...
    category: ["2026 repository sweep research-only", "appointment booking", "scheduling infrastructure", "category sweep 2026-08-18"],
  ...
  },
  {
    ...
    recommendedAction: [
      ...
      "treat files marked @license Enterprise as commercially licensed material that requires valid commercial terms before use",
      "preserve required copyright/licence notices and review trademarks separately from source-code permission",
    ],
    officialUrl: "https://github.com/twentyhq/twenty",
    repoUrl: "https://github.com/twentyhq/twenty",
    notes:
      "LICENSE re-read from the authoritative upstream on 22 September 2026. The repository is mostly AGPLv3, with Enterprise-marked files under commercial terms and named SDK/UI/application packages under MIT. The Twenty Application Exception expressly states that a separate application interacting through published Application Interfaces does not, by that interaction alone, become governed by AGPLv3. This supersedes the August record that said the licence was unread. SONARA may therefore research a separately implemented adapter against published interfaces, but source incorporation or modification of Twenty itself remains reciprocal/commercial-licence gated.",
    safetyBoundaries: [
      "published-interface integration does not authorize copying or modifying AGPL-covered Twenty core into proprietary SONARA services",
      "Enterprise-marked source stays out unless valid commercial terms are separately approved",
      "tenant identity, authorization, audit and business-record authority remain SONARA-owned even when Twenty is used through an interface",
    ],
    humanReviewRequired: true,
  },
  {
  ...
  },
  {
    name: "PostHog",
    slug: "posthog",
    category: ["2026 repository sweep research-only", "product analytics", "session replay", "feature flags", "submitted 2026-08-18"],
  ...
  },
  {
    name: "ToolJet",
    slug: "tooljet",
    category: ["2026 repository sweep research-only", "internal tool builder", "low-code", "submitted 2026-08-19"],
  ...
  },
  {
    ...
    category: ["2026 repository sweep research-only", 
      "project management",
      "work tracking",
      "reciprocal licence",
  ...
  },
  {
    ...
    slug: "mcp-typescript-sdk-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["typed MCP client/server adapters behind explicit tool allowlists"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "Apache-2.0 / MIT transition; root LICENSE says new contributions are Apache-2.0 while unrelicensed earlier contributions remain MIT",
    licenseRisk: "medium",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["adopt only behind existing authorization, tenant and audit gates", "pin package versions and validate protocol compatibility before enabling tools"],
    officialUrl: "https://modelcontextprotocol.io",
    repoUrl: "https://github.com/modelcontextprotocol/typescript-sdk",
    notes: "Active official TypeScript SDK. The 2026 root LICENSE documents an in-progress MIT-to-Apache-2.0 relicensing transition, so notices and provenance still require review.",
    safetyBoundaries: ["MCP never grants authority by itself", "tool inputs remain tenant scoped and policy checked"],
    humanReviewRequired: true,
  },
  {
    name: "OpenFeature JavaScript SDK",
    slug: "openfeature-js-sdk-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["provider-neutral feature evaluation without coupling product logic to one flag vendor"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use only after mapping evaluation to existing release and entitlement rules"],
    officialUrl: "https://openfeature.dev",
    repoUrl: "https://github.com/open-feature/js-sdk",
    notes: "Current TypeScript SDK with a narrow abstraction boundary; suitable for controlled rollouts but not security authority.",
    safetyBoundaries: ["no security decision based only on a feature flag", "fail closed for authority-sensitive capabilities"],
    humanReviewRequired: true,
  },
  {
    name: "CloudEvents JavaScript SDK",
    slug: "cloudevents-js-sdk-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["standard event envelopes across internal jobs, webhooks and provider adapters"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use for envelopes and provenance, not as a new source of truth"],
    officialUrl: "https://cloudevents.io",
    repoUrl: "https://github.com/cloudevents/sdk-javascript",
    notes: "Maintained JavaScript/TypeScript SDK. Best fit is event shape interoperability while PostgreSQL/Supabase remains canonical state.",
    safetyBoundaries: ["events are evidence, not authorization", "idempotency keys and provenance remain mandatory"],
    humanReviewRequired: true,
  },
  {
    name: "OpenTelemetry JavaScript",
    slug: "opentelemetry-js-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["traces, metrics and context propagation for route, workflow and provider reliability"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["instrument server boundaries with redaction and bounded cardinality"],
    officialUrl: "https://opentelemetry.io",
    repoUrl: "https://github.com/open-telemetry/opentelemetry-js",
    notes: "Highly active upstream and strong stack fit for observability. Export destinations remain separate operational and privacy decisions.",
    safetyBoundaries: ["never emit secrets or raw customer content", "minimize tenant identifiers in telemetry"],
    humanReviewRequired: true,
  },
  {
    name: "Temporal TypeScript SDK",
    slug: "temporal-typescript-sdk-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["checkpointed long-running workflows with retries, timers and deterministic replay"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["evaluate only for workflows that exceed the existing database-backed job model"],
    officialUrl: "https://temporal.io",
    repoUrl: "https://github.com/temporalio/sdk-typescript",
    notes: "Directly installable SDK, but production adoption adds a durable workflow control plane and therefore needs workload evidence.",
    safetyBoundaries: ["workflow replay must not duplicate money or messages", "irreversible actions remain explicitly authorized"],
    humanReviewRequired: true,
  },
  {
    name: "Qdrant JavaScript SDK",
    slug: "qdrant-js-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["isolated vector projection adapters with tenant filters and provenance"],
    productFit: ["Creator Studio", "Growth Studio", "Internal Development"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["benchmark p95 latency, recall, cost and tenant isolation against pgvector first"],
    officialUrl: "https://qdrant.tech",
    repoUrl: "https://github.com/qdrant/qdrant-js",
    notes: "Maintained SDK. SONARA should benchmark against pgvector before adding a separate vector datastore.",
    safetyBoundaries: ["tenant filter is mandatory on every retrieval", "vector storage is derived and rebuildable"],
    humanReviewRequired: true,
  },
  {
    name: "pgvector-node",
    slug: "pgvector-node-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["Node vector bindings while PostgreSQL remains canonical"],
    productFit: ["Creator Studio", "Growth Studio", "Internal Development"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["prefer before a separate vector database when PostgreSQL capacity is sufficient"],
    officialUrl: "https://github.com/pgvector/pgvector-node",
    repoUrl: "https://github.com/pgvector/pgvector-node",
    notes: "Low-friction fit with SONARA's PostgreSQL-first architecture and current RAG direction.",
    safetyBoundaries: ["organization scoping remains explicit", "embeddings never bypass provenance checks"],
    humanReviewRequired: true,
  },
  {
    name: "Supabase JavaScript Client",
    slug: "supabase-js-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["official client access to supported Supabase APIs where it reduces hand-written protocol risk"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["adopt selectively behind existing server contracts"],
    officialUrl: "https://supabase.com/docs/reference/javascript",
    repoUrl: "https://github.com/supabase/supabase-js",
    notes: "Official active SDK. Any adoption must reduce risk rather than widen browser authority.",
    safetyBoundaries: ["service-role credentials remain server-only", "RLS and explicit organization filters remain authoritative"],
    humanReviewRequired: true,
  },
  {
    name: "Stripe Node SDK",
    slug: "stripe-node-sdk-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["typed server-side Stripe API calls and webhook helpers"],
    productFit: ["Business Builder", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use where it improves existing signed webhook and checkout contracts"],
    officialUrl: "https://docs.stripe.com",
    repoUrl: "https://github.com/stripe/stripe-node",
    notes: "Official active SDK. Checkout creation still never grants paid access; verified payment events remain the entitlement boundary.",
    safetyBoundaries: ["verify webhook signatures before mutation", "never expose secret keys client-side"],
    humanReviewRequired: true,
  },
  {
    name: "Resend Node SDK",
    slug: "resend-node-sdk-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["typed server-side transactional email delivery"],
    productFit: ["Business Builder", "Growth Studio", "Internal Development"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use behind existing provider configuration and consent boundaries"],
    officialUrl: "https://resend.com",
    repoUrl: "https://github.com/resend/resend-node",
    notes: "Official active SDK. Provider delivery evidence must not be confused with business workflow completion.",
    safetyBoundaries: ["API keys remain server-only", "marketing sends require recorded consent and purpose"],
    humanReviewRequired: true,
  },
  {
    name: "Helmet",
    slug: "helmet-express-security-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["security headers for the existing Express application"],
    productFit: ["Internal Development"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["evaluate defaults against current CSP and browser regression gates before enabling"],
    officialUrl: "https://helmetjs.github.io",
    repoUrl: "https://github.com/helmetjs/helmet",
    notes: "Strong fit because SONARA intentionally remains Express. Existing CSP tests stay authoritative.",
    safetyBoundaries: ["preserve explicit CSP verification", "header changes require route regression tests"],
    humanReviewRequired: true,
  },
  {
    name: "express-rate-limit",
    slug: "express-rate-limit-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["bounded request-rate controls on abuse-prone public endpoints"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use only with deployment-appropriate state and abuse tests"],
    officialUrl: "https://github.com/express-rate-limit/express-rate-limit",
    repoUrl: "https://github.com/express-rate-limit/express-rate-limit",
    notes: "Directly installable Express middleware; distributed deployments still require a production-capable shared store or coordination strategy.",
    safetyBoundaries: ["do not use IP alone as identity", "failures must not disclose account existence"],
    humanReviewRequired: true,
  },
  {
    name: "Ajv",
    slug: "ajv-json-schema-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["JSON Schema validation at API, event and configuration boundaries"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use where a published JSON Schema already defines the contract"],
    officialUrl: "https://ajv.js.org",
    repoUrl: "https://github.com/ajv-validator/ajv",
    notes: "Mature contract validator. It complements business authorization and database constraints rather than replacing them.",
    safetyBoundaries: ["schema validity is not authorization", "reject dangerous or unknown shapes explicitly"],
    humanReviewRequired: true,
  },
  {
    name: "Zod",
    slug: "zod-schema-validation-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["runtime validation for typed adapters and internal TypeScript tooling"],
    productFit: ["Internal Development"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use when inferred types materially reduce contract drift"],
    officialUrl: "https://zod.dev",
    repoUrl: "https://github.com/colinhacks/zod",
    notes: "Very active permissive library. Adoption should follow concrete TypeScript boundaries instead of triggering a framework migration.",
    safetyBoundaries: ["validation remains explicit and tested", "do not duplicate canonical constraints without reconciliation"],
    humanReviewRequired: true,
  },
  {
    name: "BullMQ",
    slug: "bullmq-queue-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["durable background queue execution when database-backed work queues are insufficient"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["benchmark operational cost against existing job primitives before adding a queue backend"],
    officialUrl: "https://docs.bullmq.io",
    repoUrl: "https://github.com/taskforcesh/bullmq",
    notes: "Active queue platform. Technically easy to add, operationally meaningful because it introduces another execution/state layer.",
    safetyBoundaries: ["jobs require idempotency or deduplication", "dead-letter and retry policies must be observable"],
    humanReviewRequired: true,
  },
  {
    name: "Playwright",
    slug: "playwright-e2e-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["deterministic end-to-end testing for owned SONARA surfaces"],
    productFit: ["Internal Development"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use only for owned or explicitly authorized surfaces"],
    officialUrl: "https://playwright.dev",
    repoUrl: "https://github.com/microsoft/playwright",
    notes: "Current multi-browser testing framework. Highest value is exact-head release evidence for auth, checkout, tenant and accessibility flows.",
    safetyBoundaries: ["no third-party scraping without permission", "test credentials remain isolated and disposable"],
    humanReviewRequired: true,
  },
  {
    name: "Open Policy Agent",
    slug: "opa-policy-engine-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["isolated policy evaluation where policy-as-code adds measurable value"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["introduce only for a concrete policy gap with versioned policy evidence"],
    officialUrl: "https://www.openpolicyagent.org",
    repoUrl: "https://github.com/open-policy-agent/opa",
    notes: "Mature general-purpose policy engine. It would be an additional policy runtime, not a replacement for PostgreSQL RLS.",
    safetyBoundaries: ["database tenant authorization stays canonical", "policy changes require review and version evidence"],
    humanReviewRequired: true,
  },
  {
    name: "OpenFGA",
    slug: "openfga-authorization-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["relationship-based authorization experiments for complex sharing graphs"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["evaluate only against a documented authorization gap"],
    officialUrl: "https://openfga.dev",
    repoUrl: "https://github.com/openfga/openfga",
    notes: "Active Zanzibar-inspired authorization service. Avoid duplicate authority unless current organization/role/RLS models cannot express a proven requirement.",
    safetyBoundaries: ["RLS remains required at the data layer", "model changes require denial tests"],
    humanReviewRequired: true,
  },
  {
    name: "Pino",
    slug: "pino-logger-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["structured JSON application logs with low overhead"],
    productFit: ["Internal Development", "Admin Command Center"],
    license: "MIT",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["adopt with a redaction policy and stable event schema"],
    officialUrl: "https://getpino.io",
    repoUrl: "https://github.com/pinojs/pino",
    notes: "Mature Node logger with excellent stack fit. Its value depends on stable event taxonomy and redaction.",
    safetyBoundaries: ["redact secrets, tokens and private payloads", "logs are not canonical business state"],
    humanReviewRequired: true,
  },
  {
    name: "node-cron",
    slug: "node-cron-scheduler-2026",
    category: ["2026 repository sweep installable candidate"],
    useCase: ["small deterministic schedules that do not require a full durable workflow engine"],
    productFit: ["Internal Development"],
    license: "ISC",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "optional_adapter_after_review",
    recommendedAction: ["use only where deployment topology or external coordination prevents unsafe overlap"],
    officialUrl: "https://nodecron.com",
    repoUrl: "https://github.com/node-cron/node-cron",
    notes: "Current zero-dependency scheduler. Suitable for simple tasks, not sufficient alone for exactly-once distributed work.",
    safetyBoundaries: ["prevent overlapping destructive jobs", "scheduled work must be idempotent or coordinated"],
    humanReviewRequired: true,
  },
  {
    name: "ERPNext",
    slug: "erpnext-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study accounting, inventory, CRM, manufacturing and service workflow domain models"],
    ...
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["extract domain boundaries and workflow lessons without copying GPL source"],
    officialUrl: "https://erpnext.com",
    repoUrl: "https://github.com/frappe/erpnext",
    notes: "Large active ERP reference. GPL and broad product overlap make architecture research more appropriate than source adoption.",
    safetyBoundaries: ["no GPL source copied into proprietary modules", "financial records remain canonical only in approved SONARA systems"],
    humanReviewRequired: true,
  },
  {
    name: "Odoo Community",
    slug: "odoo-community-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study modular business application boundaries, workflow composition and administration UX"],
    productFit: ["Business Builder", "Research Lab"],
    license: "LGPL-3.0; Odoo Community 19.0 root LICENSE, with bundled components potentially under compatible licenses",
    licenseRisk: "high",
    reciprocalLicense: true,
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["use as a market and architecture benchmark"],
    officialUrl: "https://www.odoo.com",
    repoUrl: "https://github.com/odoo/odoo",
    notes: "Current 19.0 root LICENSE states LGPLv3. Research-only because reciprocal obligations, mixed ecosystem licensing and major product overlap make wholesale adoption strategically poor.",
    safetyBoundaries: ["no reciprocal source incorporated without legal review", "avoid duplicate customer/accounting/inventory authority"],
    humanReviewRequired: true,
  },
  {
    name: "Mautic",
    slug: "mautic-marketing-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study campaign segmentation, journeys, scoring and email orchestration"],
    productFit: ["Growth Studio", "Research Lab"],
    license: "GPL-3.0-or-later",
    licenseRisk: "high",
    reciprocalLicense: true,
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["extract product patterns while keeping outbound actions under SONARA consent and approval gates"],
    officialUrl: "https://www.mautic.org",
    repoUrl: "https://github.com/mautic/mautic",
    notes: "Active marketing automation platform. GPL and heavy overlap with Growth Studio make source incorporation unnecessary.",
    safetyBoundaries: ["no campaign send without consent and authority", "no GPL source copied into proprietary modules"],
    humanReviewRequired: true,
  },
  {
    name: "Sentry",
    slug: "sentry-observability-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study issue grouping, release health, stack-trace workflows and operational triage"],
    productFit: ["Internal Development", "Admin Command Center", "Research Lab"],
    license: "Source-available / mixed licensing; exact components and deployment mode require current review",
    licenseRisk: "high",
    reciprocalLicense: false,
    commercialUseStatus: "needs_review",
    integrationStatus: "needs_license_review",
    recommendedAction: ["evaluate hosted SDK/service separately from the self-hosted repository"],
    officialUrl: "https://sentry.io",
    repoUrl: "https://github.com/getsentry/sentry",
    notes: "High-value observability reference, but GitHub does not expose a single permissive repository license. Keep self-hosted repository use research-only until the exact components are reviewed.",
    safetyBoundaries: ["no private payloads sent without redaction", "no repository code incorporated before license review"],
    humanReviewRequired: true,
  },
  {
    name: "Appsmith",
    slug: "appsmith-internal-tools-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study low-code admin surfaces, connectors and internal-tool UX"],
    productFit: ["Admin Command Center", "Research Lab"],
    license: "Apache-2.0",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "research_only",
    recommendedAction: ["borrow interaction and connector patterns instead of introducing a second app-builder platform"],
    officialUrl: "https://www.appsmith.com",
    repoUrl: "https://github.com/appsmithorg/appsmith",
    notes: "Permissive license, but wholesale adoption would duplicate SONARA's internal/admin product surface and add a large independent runtime.",
    safetyBoundaries: ["no external admin runtime becomes authorization authority", "customer data stays behind SONARA access controls"],
    humanReviewRequired: true,
  },
  {
    name: "Activepieces",
    slug: "activepieces-automation-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study connector catalogs, visual workflow construction and agent/MCP packaging"],
    productFit: ["Growth Studio", "Admin Command Center", "Research Lab"],
    license: "MIT core with separately licensed enterprise directories",
    licenseRisk: "medium",
    reciprocalLicense: false,
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["study connector and workflow UX while retaining SONARA deterministic workflow authority"],
    officialUrl: "https://www.activepieces.com",
    repoUrl: "https://github.com/activepieces/activepieces",
    notes: "Core is permissive, enterprise areas are separate. Research-only because a second automation platform would duplicate workflow authority and widen integration risk.",
    safetyBoundaries: ["no autonomous customer action without approval policy", "exclude enterprise-licensed directories"],
    humanReviewRequired: true,
  },
  {
    name: "Medusa",
    slug: "medusa-commerce-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study modular commerce primitives, carts, orders, promotions and inventory APIs"],
    productFit: ["Business Builder", "Research Lab"],
    license: "MIT core; enterprise materials require separate commercial terms",
    licenseRisk: "medium",
    reciprocalLicense: false,
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["study module boundaries rather than adding a second commerce source of truth"],
    officialUrl: "https://medusajs.com",
    repoUrl: "https://github.com/medusajs/medusa",
    notes: "Current upstream is open-core. Strong architecture reference; direct adoption would duplicate SONARA catalog, order, customer and entitlement state.",
    safetyBoundaries: ["canonical orders and entitlements stay in SONARA", "exclude enterprise-only materials without a license"],
    humanReviewRequired: true,
  },
  {
    name: "Saleor",
    slug: "saleor-commerce-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study headless commerce APIs, checkout, channels, promotions and extensibility"],
    productFit: ["Business Builder", "Research Lab"],
    license: "BSD-3-Clause",
    licenseRisk: "low",
    reciprocalLicense: false,
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "research_only",
    recommendedAction: ["treat as architecture benchmark until a concrete missing primitive justifies an adapter"],
    officialUrl: "https://saleor.io",
    repoUrl: "https://github.com/saleor/saleor",
    notes: "Permissive and mature, but introducing it would create a full second commerce backend.",
    safetyBoundaries: ["no duplicate order or entitlement authority", "preserve tenant isolation in any reference implementation"],
    humanReviewRequired: true,
  },
  {
    name: "Gitea",
    slug: "gitea-forge-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study lightweight self-hosted Git, code review, package registry and CI/CD"],
    ...
    commercialUseStatus: "allowed_after_review",
    integrationStatus: "research_only",
    recommendedAction: ["keep GitHub as active engineering authority and use Gitea as portability research"],
    officialUrl: "https://docs.gitea.com",
    repoUrl: "https://github.com/go-gitea/gitea",
    notes: "Active self-hosted forge. Valuable for vendor-exit and private-infrastructure research, not a reason to fragment current GitHub exact-head workflows.",
    safetyBoundaries: ["do not split authoritative PR/release evidence without a migration plan", "repository mirrors are not release authority"],
    humanReviewRequired: true,
  },
  {
    name: "Forgejo",
    slug: "forgejo-forge-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study community-governed self-hosted forge, Actions, federation and privacy-oriented operations"],
    productFit: ["Internal Development", "Research Lab"],
    license: "GPL-3.0-or-later; current Forgejo v9+ releases",
    licenseRisk: "high",
    reciprocalLicense: true,
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["use as forge portability and governance benchmark"],
    officialUrl: "https://forgejo.org",
    repoUrl: "https://codeberg.org/forgejo/forgejo",
    notes: "Current Forgejo releases are GPLv3+. It is a strong self-hosting, federation and privacy reference under the Codeberg ecosystem, but direct source adoption is unnecessary.",
    safetyBoundaries: ["no GPL source incorporated into proprietary modules", "keep one authoritative release evidence chain"],
    humanReviewRequired: true,
  },
  {
    name: "GitLab Community Edition mirror",
    slug: "gitlab-ce-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study integrated CI/CD, runners, package registries, merge workflows and self-managed operations"],
    productFit: ["Internal Development", "Research Lab"],
    license: "MIT core in the mirror, with documentation and enterprise/JH directories under separate terms when present",
    licenseRisk: "medium",
    reciprocalLicense: false,
    commercialUseStatus: "needs_review",
    integrationStatus: "research_only",
    recommendedAction: ["study integrated DevSecOps patterns without replacing the current GitHub exact-head evidence pipeline"],
    officialUrl: "https://gitlab.com",
    repoUrl: "https://github.com/gitlabhq/gitlabhq",
    notes: "GitHub repository is a mirror; canonical GitLab development is on GitLab.com. Migration would be an infrastructure program rather than a package install.",
    safetyBoundaries: ["do not create two competing CI authorities", "license each directory by its actual terms"],
    humanReviewRequired: true,
  },
  {
    name: "NocoDB",
    slug: "nocodb-reference-2026",
    category: ["2026 repository sweep research-only"],
    useCase: ["study spreadsheet-like database UX, APIs and collaborative data views"],
    productFit: ["Business Builder", "Admin Command Center", "Research Lab"],
    license: "Sustainable Use License 1.0 on current master/develop; source-available, not OSI open source",
    licenseRisk: "high",
    reciprocalLicense: false,
    commercialUseStatus: "needs_review",
    integrationStatus: "needs_license_review",
    recommendedAction: ["research interaction patterns only; do not embed or provide as part of SONARA without legal review"],
    officialUrl: "https://nocodb.com",
    repoUrl: "https://github.com/nocodb/nocodb",
    notes: "Current license limits use/modification to internal business purposes or non-commercial/personal use. It is therefore research-only for a commercial hosted product absent a separate legal conclusion.",
    safetyBoundaries: ["no NocoDB code embedded into customer-facing SONARA", "no second database authority created by convenience UI"],
    humanReviewRequired: true,
  },
