    ...
    <PublicShell>
      <section className="rounded-3xl border border-[#2A2A35] bg-[#171720] p-6">
        ...
        <div className="mt-4 grid max-w-3xl gap-4 leading-7 text-[#A1A1AA]">
          <p>
            SONARA Industries is the parent company for independent systems serving creator technology, restaurant
            operations, and verified local information workflows.
          </p>
          <p>
