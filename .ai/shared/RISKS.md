...
8. **Supabase hardening:** recorded advisor items include leaked-password protection, function/search-path/RPC review, and extension placement. Applied migrations are immutable; remediation requires new reviewed migrations and RLS regression tests.
