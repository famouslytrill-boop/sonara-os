      ...
      <main id="sonara-main" class="${mainClass}" data-sonara-surface="${isMarketing ? "marketing" : "work"}" data-sonara-interface="live" data-layout-contract="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); overflow-wrap: anywhere; word-break: break-word">
        <section class="hero sonara-hero-stage">
          ...
          ${variant === "home" ? `<div class="sonara-hero-scene" aria-label="SONARA One workspace preview">
            <div class="sonara-interface-preview">
              <div class="sonara-interface-preview__topline"><span class="sonara-interface-preview__eyebrow">SONARA ONE / WORKSPACE</span><span class="sonara-interface-preview__signal">Readiness review</span></div>
              ...
              <div class="sonara-interface-preview__footer"><span>Build</span><span>Create</span><span>Grow</span><a href="/readiness">View readiness</a></div>
            </div>
          </div>` : ""}
        </section>
        ${variant === "home" ? `<section class="sonara-home-quickstart" aria-label="SONARA One quickstart">
          ...
          <div class="sonara-home-quickstart__grid">
            <a class="sonara-quickstart-card sonara-quickstart-card--business" href="/business-builder/intake"><strong>Business Builder</strong><span>Start an intake</span><small>Offers, customers, bookings, and payments.</small></a>
            ...
            <a class="sonara-quickstart-card sonara-quickstart-card--setup" href="/readiness"><strong>Shared setup</strong><span>Review readiness</span><small>See what is configured and what still needs attention.</small></a>
          </div>
        </section>` : ""}
