...
function createPageFrame(deps = {}) {
  ...
  function layout({ title, eyebrow, heading, body, sections, actions, variant = "standard", surface = "work" }) {
  ...
  <html lang="en">
    <head>
      ...
      <link rel="preload" href="/fonts/geist-latin.woff2?v=sonara-ui-20260725-v6-motion3" as="font" type="font/woff2" crossorigin>
      <link rel="stylesheet" href="/sonara-fonts.css?v=sonara-ui-20260725-v6-motion3">
      ...
      ${isMarketing ? `<script defer src="/sonara-depth.js?v=sonara-ui-20260725-v6-motion3"></script>` : ""}
    </head>
