...
function createPageFrame(deps = {}) {
  ...
  // of them wanted it.
  function layout({ title, eyebrow, heading, body, sections, actions, variant = "standard", surface = "work", canonical = "", scripts = [] }) {
    ...
    <body class="${escapeHtml(brandClass)} ${variant === "home" ? "sonara-home-v3" : "sonara-standard-page"}">
      ...
      <header class="sonara-site-header">
        ...
        <nav class="sonara-desktop-nav" aria-label="Primary">
          <details class="sonara-workspace-menu"><summary>Products</summary><div><a href="/business-builder">Business Builder</a><a href="/creator-studio">Creator Studio</a><a href="/growth-studio">Growth Studio</a></div></details>
