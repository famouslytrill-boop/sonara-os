...
function createPageFrame(deps = {}) {
  ...
  const { legalPages, safeListTable } = deps;
        ...
        <section class="hero sonara-hero-stage">
          ...
          ${variant === "home" ? `<div class="sonara-hero-scene" aria-label="SONARA One workspace preview">
            <div class="sonara-interface-preview">
              <div class="sonara-interface-preview__topline"><span class="sonara-interface-preview__eyebrow">SONARA ONE / WORKSPACE</span><span class="sonara-interface-preview__signal">Setup review</span></div>
              <div class="sonara-interface-preview__heading"><strong>Next useful action</strong><span>Choose a workspace to begin</span></div>
              <div class="sonara-interface-preview__statuses" aria-label="Workspace readiness">
                <div><span class="sonara-status-dot" aria-hidden="true"></span><span>Account</span><strong>Review setup</strong></div>
                <div><span class="sonara-status-dot" aria-hidden="true"></span><span>Records</span><strong>Connect workspace</strong></div>
                <div><span class="sonara-status-dot" aria-hidden="true"></span><span>Payments</span><strong>Check pricing</strong></div>
                <div><span class="sonara-status-dot" aria-hidden="true"></span><span>Support</span><strong>Available</strong></div>
              </div>
