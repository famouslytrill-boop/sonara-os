    ...
    lines: [
      {
        ...
        columns: [
          { label: "Person", value: (row) => text(row.employee_id, "Not set") },
          { label: "Role", value: (row) => text(row.role_label, "Not set") },
      ...
      },
      {
        ...
        totalFrom: "unit_cost_cents",
        columns: [
          { label: "Item", value: (row) => text(row.description || row.inventory_item_id, "Not described") },
