...
const REFERENCE_SOURCES = Object.freeze({
  ...
  vehicles: { table: "vehicle_records", label: (row) => row.registration_number || row.vehicle_type || row.id },
  productVariants: {
    ...
    lines: [
      ...
      },
      {
        ...
        form: {
          ...
          fields: [
            { name: "evidence_type", label: "Kind", type: "select", options: ["note", "photo_reference", "document_reference", "signature_reference", "measurement", "checklist"] },
            { name: "note", label: "What proves the work", type: "textarea", maxLength: 2000 },
