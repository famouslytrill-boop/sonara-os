...
function createReadiness(deps = {}) {
  ...
  function getReadiness() {
    ...
    //
    // Deferred rather than dropped, and reported in its own bucket beside
    // `missing`, because a variable nobody is waiting for and a variable nobody
    // has noticed are different facts and the owner needs to see both. This is
    // the same shape as googleOAuth, which has read "deferred" here for months.
