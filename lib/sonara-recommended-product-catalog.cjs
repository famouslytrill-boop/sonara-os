...
const PRICE_NOTES = Object.freeze({
  ...
  starter: "Starter plan floor; paid execution remains restricted until production entitlement verification passes.",
  core: "Core plan floor; paid execution remains restricted until production entitlement verification passes.",
  pro: "Pro plan floor; paid execution remains restricted until production entitlement verification passes."
});
