...
const SCREENSHOT_TOOL_RADAR_BATCH2 = Object.freeze([
  ...
  record({
    ...
    safety: [
      ...
      "Independently verify every third-party API's terms, privacy posture, data provenance, pricing, consent requirements, and platform rules before any integration.",
