...
function createProductPages({ linkAction, logoutAction }) {
    ...
    const definitions = {
      "business-builder": {
        free: [
          ...
          { path: "/business-builder/intake", label: "Legacy customer request path", title: "Business Builder Launch Checklist", module: "intake", body: "This older request path now points customers to the direct workspace setup flow.", visible: false, redirectTo: "/business-builder/launch-readiness" },
        ...
        paid: [
          ...
          { path: "/business-builder/payments", label: "Payments", title: "Payments", module: "payments", body: "Taking payments needs checkout switched on, your payment provider able to report back, and your billing records confirmed." },
  ...
  function productLandingActions(slug) {
    if (slug === "business-builder") {
      return [
        ...
        linkAction("/search", "Search your records"),
        linkAction("/business-builder/owner/money-due", "Money due in and out"),
        linkAction("/business-builder/owner/chase-drafts", "Chase drafts"),
        linkAction("/business-builder/owner/local-model", "Local model"),
    ...
    if (slug === "growth-studio") {
      return [
        linkAction("/search", "Search your records"),
        linkAction("/growth-studio/assistant", "What needs attention"),
        linkAction("/growth-studio/journey", "Where people fall out"),
  ...
  function productDashboardActions(slug) {
    ...
    if (slug === "creator-studio") {
      return [
        // First, because it is the only one that tells the customer something
        // they were not already looking for -- consent that has quietly expired,
        // a release whose date has passed.
        linkAction("/search", "Search your records"),
        linkAction("/creator-studio/assistant", "What needs attention"),
        linkAction("/creator-studio/assets", "Assets"),
        linkAction("/creator-studio/offers/free", "Offer draft"),
