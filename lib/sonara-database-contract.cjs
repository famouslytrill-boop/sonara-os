...
const DATABASE_INDEXES = Object.freeze([
  ...
  Object.freeze({ name: "business_workspaces_org_active_idx", table: "business_workspaces" }),
  Object.freeze({ name: "business_permission_grants_lookup_idx", table: "business_permission_grants" }),
  Object.freeze({ name: "business_control_audit_business_idx", table: "business_control_audit_events" }),
  Object.freeze({ name: "business_integration_connections_business_idx", table: "business_integration_connections" })
]);
