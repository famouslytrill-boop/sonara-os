...
function createRateLimiter({ name, windowSeconds, maxAttempts, degradedMaxAttempts = Math.max(maxAttempts + 20, maxAttempts * 2), scopes = ["ip"], subjectFrom, getSupabaseServerConfig, onDegraded = defaultDegradedReport, renderDenied }) {
