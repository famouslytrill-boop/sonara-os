...
const RESERVED_HANDLES = Object.freeze(new Set([
  ...
  "dashboard", "deliverables", "earnings-disclaimer", "forgot-password", "free-tools", "free-launch-stack",
  "growth-studio", "help", "how-it-works", "leadforge", "legal", "login", "logout",
  "market-intelligence", "notifications", "owner", "pricing", "privacy", "technology-radar",
  ...
  "signup", "sitemap", "start", "support", "terms", "tutorials", "workspace-modules",
