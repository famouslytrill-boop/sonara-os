...
const RESERVED_HANDLES = Object.freeze(new Set([
  ...
  "growth-studio", "help", "how-it-works", "legal", "login", "logout",
  "market-intelligence", "notifications", "owner", "pricing", "privacy",
  "product-lifecycle", "products", "prompt-library", "refund-policy", "requests",
  "reset-password", "robots", "search", "security", "service-catalog", "shared",
