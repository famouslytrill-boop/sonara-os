...
const CUSTOMER_ROUTES = [
  ...
  "/account/integrations", "/account/data", "/product-lifecycle", "/market-intelligence", "/owner/agent-activity"
];
...
const PRODUCT_ENTRY_ROUTES = new Set([
  "/business-builder/start", "/business-builder/tools", "/business-builder/catalog", "/business-builder/support",
  "/creator-studio/start", "/creator-studio/tools", "/creator-studio/content", "/creator-studio/support",
  "/growth-studio/start", "/growth-studio/tools", "/growth-studio/catalog", "/growth-studio/content", "/growth-studio/support"
]);
...
function makeRecord(route, visibility, productOwner = "sonara_industries") {
  ...
  // untrue about it.
  const openToAnyone = visibility === "product" && PRODUCT_ENTRY_ROUTES.has(route);
