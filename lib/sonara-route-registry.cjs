...
const CUSTOMER_ROUTES = [
  ...
  "/account/integrations", "/account/data", "/account/following", "/product-lifecycle", "/market-intelligence", "/invention-systems", "/owner/agent-activity"
];
...
const TITLE_OVERRIDES = {
  ...
  "/invention-systems": "SONARA Invention Systems",
