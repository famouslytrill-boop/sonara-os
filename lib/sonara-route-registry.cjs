...
const CUSTOMER_ROUTES = [
  ...
  "/account/integrations", "/account/data", "/account/following", "/product-lifecycle", "/market-intelligence", "/market-intelligence/invention-systems", "/owner/agent-activity"
];
...
const ADMIN_ROUTES = [
  ...
  "/admin/ai-integrations", "/admin/system-design-intelligence", "/admin/model-safety-resilience", "/admin/agent-activity",
...
const PRODUCT_ROUTES = {
  ...
  creator_studio: [
    ...
    "/creator-studio/media-production", "/api/creator/media-production/schema", "/api/creator/media-production/validate", "/api/creator/media-production/plan", "/creator-studio/generation", "/creator-studio/generation/jobs", "/creator-studio/generation/voice", "/creator-studio/generation/music", "/creator-studio/generation/audio", "/creator-studio/generation/image", "/creator-studio/generation/video", "/creator-studio/generation/reference-analysis", "/creator-studio/product-lifecycle", "/creator-studio/market-intelligence",
