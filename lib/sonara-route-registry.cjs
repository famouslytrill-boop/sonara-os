...
const PRODUCT_ROUTES = {
  ...
  creator_studio: [
    ...
    "/creator-studio/media-production", "/creator-studio/generation", "/creator-studio/generation/jobs", "/creator-studio/generation/voice", "/creator-studio/generation/music", "/creator-studio/generation/audio", "/creator-studio/generation/image", "/creator-studio/generation/video", "/creator-studio/generation/reference-analysis", "/creator-studio/product-lifecycle", "/creator-studio/market-intelligence",
