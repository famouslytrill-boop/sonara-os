...
const SONARA_ECOSYSTEM_MANIFEST = {
  ...
  adminControlPlane: {
    routes: ["/admin", "/admin/users", "/admin/roles", "/admin/subscriptions", "/admin/webhooks", "/admin/support", "/admin/catalog", "/admin/system", "/admin/formulas", "/admin/ecosystem", "/admin/ai-integrations"],
    duties: [
