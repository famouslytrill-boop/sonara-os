...
const SUBSYSTEMS = Object.freeze([
  ...
  },
  {
    ...
    body: "Fingerprints used to tell one piece of work from another, and the release plans that hang off them.",
    status: "song_fingerprints backs anti-clone matching, which needs a designed safety flow before anything acts on a match. Nothing matches or blocks today.",
  ...
  },
  {
    ...
    status: "Reference and reporting rather than a workspace. business_vertical_templates would fit the Business Builder setup flow if that gets built.",
    tables: ["business_vertical_templates", "sonara_module_dependencies", "pos_menu_mix_items", "service_comments"]
  },
  {
