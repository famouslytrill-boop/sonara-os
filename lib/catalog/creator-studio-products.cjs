...
module.exports = Object.freeze([
  ...
  [
    ...
    "Storyboard Builder",
    "content",
    "A numbered shot list with camera angle, purpose and transition for each shot, whose seconds add up to the runtime you actually have.",
    "Walk onto a shoot with a plan that fits the slot.",
    "free",
    "active",
    "/creator-studio/tools/storyboard",
    "shot list|per-shot seconds|camera angle|transitions|caption safe area",
    "module_outputs|storyboard tool",
    "A plan, not footage. It generates nothing and sends nothing, and music, footage and anybody recognisable still need clearing before publication."
  ],
]);
