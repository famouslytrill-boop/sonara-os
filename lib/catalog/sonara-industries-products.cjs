...
module.exports = Object.freeze([
  [
    ...
    "platform",
    "Your workspaces, billing, requests and recent activity in one place across all three studios.",
  ...
  [
    ...
    "Connected Accounts",
    "integrations",
    // "file storage" survived here after the storage product itself was rewritten,
    // which is how a phrase outlives the thing it described.
    "Safe connections to payments, email, publishing, and analytics.",
  ...
  [
    ...
    "Research & Roadmap",
    "strategy",
    "Dated competitor research, market signals, and the stop rules written down before anybody acts on them.",
