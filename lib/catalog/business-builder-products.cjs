...
module.exports = Object.freeze([
  ...
  [
    ...
    "payments",
    "Quotes, invoice records, payment links, payment status, and the handoff back to your customer.",
    "Go from an accepted quote to money received, without ever touching your customer's card details.",
    "core",
    "beta",
    "/business-builder/billing",
    "quotes|invoices|payment links|checkout|webhooks|billing portal",
