...
const CONNECTOR_DOMAIN_MAP = Object.freeze([
  Object.freeze({ key: "ai_models_and_agents", owner: "Nexus", examples: ["LLM providers", "MCP tools", "RAG stores", "generation providers"] }),
  Object.freeze({ key: "identity_collaboration_storage", owner: "Nexus", examples: ["Google Workspace", "Microsoft Graph", "Slack", "GitHub", "file storage"] }),
  ...
  Object.freeze({ key: "devices_spatial_realtime", owner: "Nexus", examples: ["cameras", "GPS", "gyroscope", "AR", "notifications", "haptics", "realtime communications"] })
]);
