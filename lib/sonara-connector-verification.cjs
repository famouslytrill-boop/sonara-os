...
const { getIntegrationCheckpointArchitecture } = require("./sonara-integration-checkpoint-contract.cjs");
...
function getConnectorVerificationArchitecture() {
  return Object.freeze({
    ...
    checkpointArchitecture: getIntegrationCheckpointArchitecture(),
