...
//
// The plain-language crawl in tests/plain-language.test.js does not cover this:
// it reads pages that answer 200 to an anonymous request, and generation is
// behind a paid workspace. That is a limit on the gate's reach rather than a
// pass, which is how these survived.
// ---------------------------------------------------------------------------
