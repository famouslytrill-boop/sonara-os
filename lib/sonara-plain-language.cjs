...
const GENERATION_FAILURE = Object.freeze({
  storage_upload_failed_413: "The finished file was too large to save. Generate a shorter piece, or ask us to raise your storage limit.",
  storage_upload_failed_402: "The finished file was larger than this account's storage allows. Ask us to raise your storage limit.",
