...
const SOCIAL_REPOSITORY_INTAKE = Object.freeze([
  ...
  source("r", "19UAV4yLf7", "verified_repository", ["mattpocock-skills"], "The repository identity matched the engineering skills collection. Re-pointed 9 September 2026: this source was governed by `mattpocock-engineering-skills-reference`, which was a second register record for mattpocock/skills and has been merged into `mattpocock-skills`. The intake names the record that governs a submitted repository, so it follows the merge."),
