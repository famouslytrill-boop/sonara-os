...
// One text is one unit; a call is billed per minute, rounded up, because that is
// how every carrier bills and pretending otherwise would put us underwater on
// every part-minute.
