...
//
// **Measured 16 September 2026: the server answers 558 GET routes.** 250 of
...
// routes against a configured server as an anonymous visitor. Sixty-six of them
// had never been probed by anything before that test existed. Every value here
