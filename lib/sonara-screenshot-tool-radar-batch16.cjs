...
const ARCHITECTURE_EXTENSIONS = [
  ...
  },
  {
    ...
    implementation: "Repository-native AGENTS/project-memory/handoff files, deterministic pnpm verification commands, and exact-head CI define the contract; no coding client becomes merge or release authority."
  },
  {
