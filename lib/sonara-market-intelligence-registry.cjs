  ...
  markets: Object.freeze({
    business_builder: Object.freeze({
      ...
      agentAndWorkflowPolicy: Object.freeze({
        ...
        executionRule: "A model may propose an action, but a tenant-scoped deterministic command validates authority, required fields, duplicate-action protection, budget, approval state, and evidence before any change."
      }),
