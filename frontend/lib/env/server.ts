...
export const envVarDefinitions: EnvVarDefinition[] = [
  ...
  { name: "STRIPE_CREATOR_MONTHLY_PRICE_ID", scope: "server", requiredFor: "checkout" },
  { name: "STRIPE_PRO_MONTHLY_PRICE_ID", scope: "server", requiredFor: "checkout" },
  { name: "STRIPE_LABEL_MONTHLY_PRICE_ID", scope: "server", requiredFor: "checkout" },
